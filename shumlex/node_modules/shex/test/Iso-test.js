...
describe('graph equiv', function () {
  ...
  var robj = {"_size":null,"_graphs":{"":{"subjects":{"1":{"2":{"3":null},"8":{"9":null}},"3":{"4":{"5":null},"6":{"7":null}},"9":{"4":{"5":null},"6":{"10":null}}},"predicates":{"2":{"3":{"1":null}},"4":{"5":{"3":null,"9":null}},"6":{"7":{"3":null},"10":{"9":null}},"8":{"9":{"1":null}}},"objects":{"3":{"1":{"2":null}},"5":{"3":{"4":null},"9":{"4":null}},"7":{"3":{"6":null}},"9":{"1":{"8":null}},"10":{"9":{"6":null}}}}},"_id":10,"_ids":{"><":0,"tag:b0":1,"http://shex.io/extensions/Map/#BPunitsDAM-diastolic":2,"_:b8":3,"http://shex.io/extensions/Map/#BPunitsDAM-units":4,"\"mmHg\"":5,"http://shex.io/extensions/Map/#BPunitsDAM-value":6,"\"70\"^^http://www.w3.org/2001/XMLSchema#float":7,"http://shex.io/extensions/Map/#BPunitsDAM-systolic":8,"_:b7":9,"\"110\"^^http://www.w3.org/2001/XMLSchema#float":10},"_entities":{"1":"tag:b0","2":"http://shex.io/extensions/Map/#BPunitsDAM-diastolic","3":"_:b8","4":"http://shex.io/extensions/Map/#BPunitsDAM-units","5":"\"mmHg\"","6":"http://shex.io/extensions/Map/#BPunitsDAM-value","7":"\"70\"^^http://www.w3.org/2001/XMLSchema#float","8":"http://shex.io/extensions/Map/#BPunitsDAM-systolic","9":"_:b7","10":"\"110\"^^http://www.w3.org/2001/XMLSchema#float"},"_blankNodeIndex":0,"_prefixes":{}};
  let m = {};
  let mgood = { '_:b1': '_:b8', '_:b0': '_:b7' };
  let mbad = { '_:b0': '_:b8', '_:b1': '_:b7' };
  it('l == r', function () {
    Object.assign(l, lobj);
    expect(geq(l, r, m)).to.be.true;
    expect(m).to.deep.equal(mgood);
    expect(m).to.deep.not.equal(mbad);
  });
  xit('i(l) == r', function () {
    Object.assign(l, lobj);
    expect(geq(l, r)).to.be.true;
  });
  it('i(l) == i(r)', function () {
    Object.assign(r, robj);
    expect(geq(l, r, mgood)).to.be.true;
    debugger;
    expect(geq(l, r)).to.be.true;
  });
});
